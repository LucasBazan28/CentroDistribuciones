...
export default function ProductCard({
  ...
  return (
    <div className="group overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-md transition-all hover:-translate-y-1 hover:shadow-xl">
      {/* Product image */}
      <div
      ...
      <div className="p-5">
        ...
        {/* Brand Info */}
        {product.marcas && (
          <p className="mt-1 text-xs text-gray-500">{product.marcas.nombre}</p>
        )}
        ...
        <div className="mt-3 flex flex-col gap-2">
          ...
          <Link
            ...
            className="w-full rounded-lg bg-primary/10 px-3 py-1.5 text-center text-xs font-semibold text-primary transition-colors hover:bg-primary hover:text-white"
          >
            Ver más
          </Link>
        </div>
